		...
		stage('Push Docker Image') {
			steps {
				withAWS(region:'us-west-2',credentials:'CapstoneCredential') {
					...
					sh 'docker tag mayank/my-app:latest 430721128257.dkr.ecr.us-west-2.amazonaws.com/mayank-repo/my-app:latest'
					sh 'docker push 430721128257.dkr.ecr.us-west-2.amazonaws.com/mayank-repo/my-app:latest'
				}
			}
		}
